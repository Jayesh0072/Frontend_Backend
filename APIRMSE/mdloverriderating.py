...
# The error was: Table , does not exist.
# Unable to inspect table 'FL_Question_Rating_Data_Final,ICQ_Question_Rating_Data'
# The error was: Table FL_Question_Rating_Data_Final,ICQ_Question_Rating_Data does not exist.
# Unable to inspect table ','
# The error was: Table , does not exist.
...
# Unable to inspect table ',Udaap_Question_Rating_Data'
# The error was: Table ,Udaap_Question_Rating_Data does not exist.
# Unable to inspect table ','
# The error was: Table , does not exist.
