...
def SVMAjax():
    try:
        ...
        pdf = exportPdf(10, 10, pdf, document,  os.path.join(
            BASE_DIR, 'static\media\\', file_name+"SVM_NT_roc1.png"),
            "ROC Curve Validation data", os.path.join(
            BASE_DIR, 'static\media\\', file_name+"SVM_NT_roc2.png"),
            "ROC Curve Test data", "Support Machine Vector - No Parameters Tuning")
        pdf.add_page()
        pdf = exportPdf(10, 10, pdf, document,  os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_NT_train_data.png"),
            "Confusion Matrix Validation data", os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_NT_val_data.png"),
            "Confusion Matrix Test data", "Support Machine Vector - No Parameters Tuning")
        pdf.add_page()
        pdf = exportTestResultPdf(
            10, 10, pdf, NT_auc_ginin_output, "Support Machine Vector - No Parameters Tuning")

        NT_roc_file1 = "\\static\\media\\" + file_name+"SVM_NT_roc1.png"
        NT_roc_file2 = "\\static\\media\\" + file_name+"SVM_NT_roc2.png"
        ...
        drawConfMatrix(y_train, pred_svm_train0,
                       file_name + "_SVM_RS_train_data.png")

        # show the confusion matrix for validation data

        drawConfMatrix(y_val, pred_svm_val0,
                       file_name + "_SVM_RS_val_data.png")

        RS_roc_file1 = "\\static\\media\\" + file_name + "_SVM_RS_roc1.png"
        RS_roc_file2 = "\\static\\media\\" + file_name + "_SVM_RS_roc2.png"
        ...
        pdf.add_page()
        pdf = exportPdf(10, 10, pdf, document,  os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_RS_roc1.png"),
            "ROC Curve Validation data", os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_RS_roc2.png"),
            "ROC Curve Test data", "Support Machine Vector - Random Search")
        pdf.add_page()
        pdf = exportPdf(10, 10, pdf, document,  os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_RS_train_data.png"),
            "Confusion Matrix Validation data", os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_RS_val_data.png"),
            "Confusion Matrix Test data", "Support Machine Vector - Random Search")
        pdf.add_page()
        pdf = exportTestResultPdf(
        ...
        drawConfMatrix(y_train, pred_svm_train1,
                       file_name + "_SVM_GS_train_data.png")

        # show the confusion matrix for validation data

        drawConfMatrix(y_val, pred_svm_val1,
                       file_name + "_SVM_GS_val_data.png")

        GS_roc_file1 = "\\static\\media\\" + file_name + "_SVM_GS_roc1.png"
        GS_roc_file2 = "\\static\\media\\" + file_name + "_SVM_GS_roc2.png"
        ...
        pdf.add_page()
        pdf = exportPdf(10, 10, pdf, document,  os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_GS_roc1.png"),
            "ROC Curve Validation data", os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_GS_roc2.png"),
            "ROC Curve Test data", "Support Machine Vector - Grid Search")
        pdf.add_page()
        pdf = exportPdf(10, 10, pdf, document,  os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_GS_train_data.png"),
            "Confusion Matrix Validation data", os.path.join(
            BASE_DIR, 'static\media\\', file_name+"_SVM_GS_val_data.png"),
            "Confusion Matrix Test data", "Support Machine Vector - Grid Search")
        pdf.add_page()
        pdf = exportTestResultPdf(
            10, 10, pdf, GS_auc_ginin_output, "Support Machine Vector - Grid Search")

        pdf.output(os.path.join(
            BASE_DIR, "static\\media\\" + file_name + "_SVM_Output.pdf"))
        context = {'pdfFile': "\\static\\media\\" + file_name + "_SVM_Output.pdf", 'model': 'SVM',  'tableHead': 'Support Machine Vector', 'NT_rocgraphpath1': NT_roc_file1, 'NT_rocgraphpath2': NT_roc_file2, 'NT_auc_ginin_output': NT_auc_ginin_output,
                   'NT_graphConfMat1': "\\static\\media\\" + file_name + "_SVM_NT_train_data.png", 'NT_graphConfMat2': "\\static\\media\\" + file_name + "_SVM_NT_val_data.png",
                   'RS_rocgraphpath1': RS_roc_file1, 'RS_rocgraphpath2': RS_roc_file2, 'RS_auc_ginin_output': RS_auc_ginin_output,
                   'RS_graphConfMat1': "\\static\\media\\" + file_name + "_SVM_RS_train_data.png", 'RS_graphConfMat2': "\\static\\media\\" + file_name + "_SVM_RS_val_data.png",
                   'GS_rocgraphpath1': GS_roc_file1, 'GS_rocgraphpath2': GS_roc_file2, 'GS_auc_ginin_output': GS_auc_ginin_output,
                   'GS_graphConfMat1': "\\static\\media\\" + file_name + "_SVM_GS_train_data.png", 'GS_graphConfMat2': "\\static\\media\\" + file_name + "_SVM_GS_val_data.png"}
